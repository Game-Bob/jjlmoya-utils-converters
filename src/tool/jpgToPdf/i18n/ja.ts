...
const title = "JPG PDF 変換ツール";
const description = "ブラウザ上でJPG画像を整列されたPDFに変換。ファイルをアップロードすることなく、用紙サイズや向き、余白を設定できます。";

const ui: ImageToPdfUI = {
  formatLabel: 'JPG',
  dropTitle: "JPG画像からPDFを作成",
  dropText: "ここにJPGファイルをドロップ。選択した順番がそのままページ順になります。",
  selectFiles: "JPGファイルを選択",
  ...
  invalidFile: "このツールはJPGおよびJPEGファイルのみに対応しています。",
...
const faq: JpgToPdfLocaleContent['faq'] = [
  {
    "question": "複数のJPG画像を1つのPDFにまとめられますか？",
    "answer": "はい。必要なだけのJPGファイルを選択し、ページ順を整えて1つのPDFファイルとして出力できます。"
  },
  {
...
const howTo: JpgToPdfLocaleContent['howTo'] = [
  {
    "name": "JPG画像を選択",
    "text": "JPGファイルをドラッグ＆ドロップするか、デバイスから選択します。"
  },
  {
    "name": "ページと用紙の設定",
...
const seo: JpgToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "JPG画像を印刷に適した高品質なPDFへ変換",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "複数枚のJPG画像やスキャンデータを、1つのきれいなPDFファイルにまとめるツールです。ページ順の変更や用紙サイズ・余白の指定も簡単に行えます。"
  },
  {
    "type": "title",
