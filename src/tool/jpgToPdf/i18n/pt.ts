...
const slug = 'conversor-jpg-para-pdf';
const title = "Conversor de JPG para PDF";
const description = "Converta imagens JPG num PDF ordenado no seu navegador. Escolha o tamanho do papel, orientação e margens sem carregar ficheiros.";

const ui: ImageToPdfUI = {
  formatLabel: 'JPG',
  dropTitle: "Crie um PDF a partir das suas imagens JPG",
  dropText: "Arraste ficheiros JPG para aqui. A ordem escolhida será a ordem das páginas.",
  selectFiles: "Selecionar ficheiros JPG",
  ...
  invalidFile: "Esta ferramenta aceita apenas ficheiros JPG e JPEG.",
...
const faq: JpgToPdfLocaleContent['faq'] = [
  {
    "question": "Posso juntar várias imagens JPG num único PDF?",
    "answer": "Sim. Selecione os ficheiros JPG, ordene as páginas e exporte um único documento PDF."
  },
  {
...
const howTo: JpgToPdfLocaleContent['howTo'] = [
  {
    "name": "Selecione as imagens JPG",
    "text": "Arraste os seus ficheiros JPG ou escolha-os no seu dispositivo."
  },
  {
...
const seo: JpgToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "Crie um documento PDF pronto a imprimir a partir de imagens JPG",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "Este conversor de JPG para PDF foi concebido para agrupar fotos ou digitalizações num único ficheiro organizado. Ajuste a ordem e as definições de página facilmente."
  },
  {
    "type": "title",
