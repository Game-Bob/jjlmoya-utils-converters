...
const slug = 'webp-pdf-donusturucu';
const title = "WebP PDF Dönüştürücü";
const description = "WebP görsellerini tarayıcınızda sıralı bir PDF dosyasına dönüştürün. Dosya yüklemeden kağıt boyutu, yönlendirme ve kenar boşluklarını seçin.";

const ui: ImageToPdfUI = {
  formatLabel: 'WebP',
  dropTitle: "WebP görsellerinizden PDF oluşturun",
  dropText: "WebP dosyalarını buraya sürükleyin. Seçtiğiniz sıra sayfa sırası olacaktır.",
  selectFiles: "WebP dosyalarını seçin",
  ...
  invalidFile: "Bu araç yalnızca WebP ve JPEG dosyalarını kabul eder.",
...
const faq: WebpToPdfLocaleContent['faq'] = [
  {
    "question": "Birden fazla WebP görselini tek bir PDF de birleştirebilir miyim?",
    "answer": "Evet. İstediğiniz kadar WebP dosyası seçin, sayfa sırasını düzenleyin ve tek bir PDF olarak indirin."
  },
  {
...
const howTo: WebpToPdfLocaleContent['howTo'] = [
  {
    "name": "WebP görsellerini seçin",
    "text": "WebP dosyalarınızı sürükleyin veya cihazınızdan seçin."
  },
  {
...
const seo: WebpToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "WebP görsellerinizi baskıya hazır bir PDF dokümanına dönüştürün",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "Bu WebP - PDF dönüştürücü, fotoğraflarınızı veya taramalarınızı düzenli tek bir PDF dosyasında toplamanıza olanak tanır. Sayfa sırasını ve kağıt ayarlarını kolayca yapın."
  },
  {
    "type": "title",
