...
const slug = 'convertidor-webp-a-pdf';
const title = "Convertidor de WebP a PDF";
const description = "Convierte imágenes WebP en un PDF ordenado desde tu navegador. Elige tamaño de papel, orientación y márgenes sin subir archivos.";

const ui: ImageToPdfUI = {
  formatLabel: 'WebP',
  dropTitle: "Crea un PDF a partir de tus imágenes WebP",
  dropText: "Arrastra archivos WebP aquí. El orden que elijas será el orden de las páginas.",
  selectFiles: "Seleccionar archivos WebP",
  ...
  invalidFile: "Esta herramienta solo acepta archivos WebP y JPEG.",
...
const faq: WebpToPdfLocaleContent['faq'] = [
  {
    "question": "¿Puedo juntar varias imágenes WebP en un solo PDF?",
    "answer": "Sí. Selecciona los archivos WebP que necesites, ordena las páginas y exporta un único PDF."
  },
  {
...
const howTo: WebpToPdfLocaleContent['howTo'] = [
  {
    "name": "Selecciona las imágenes WebP",
    "text": "Arrastra tus archivos WebP o elígelos desde tu dispositivo."
  },
  {
...
const seo: WebpToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "Crea un documento PDF listo para imprimir desde tus imágenes WebP",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "Este convertidor de WebP a PDF está pensado para unificar listas de fotos, escaneos o documentos en un solo archivo organizado. Reordena las páginas y ajusta el tipo de papel antes de exportar."
  },
  {
    "type": "title",
