...
const title = "WebP를 PDF로 변환하는 툴";
const description = "브라우저에서 WebP 이미지를 정렬된 PDF 문서로 변환하세요. 파일 업로드 없이 용지 크기, 방향, 여백을 자유롭게 설정할 수 있습니다.";

const ui: ImageToPdfUI = {
  formatLabel: 'WebP',
  dropTitle: "WebP 이미지로 PDF 만들기",
  dropText: "여기에 WebP 파일을 끌어다 놓으세요. 선택한 순서가 페이지 순서가 됩니다.",
  selectFiles: "WebP 파일 선택",
  ...
  invalidFile: "이 툴은 WebP 및 JPEG 파일만 지원합니다.",
...
const faq: WebpToPdfLocaleContent['faq'] = [
  {
    "question": "여러 개의 WebP 이미지를 하나의 PDF로 합칠 수 있나요?",
    "answer": "네. 원하는 수만큼 WebP 파일을 선택하고 순서를 정한 뒤 하나의 PDF로 내보낼 수 있습니다."
  },
  {
...
const howTo: WebpToPdfLocaleContent['howTo'] = [
  {
    "name": "WebP 이미지 선택",
    "text": "WebP 파일을 끌어다 놓거나 기기에서 선택합니다."
  },
  {
    "name": "페이지 및 용지 설정",
...
const seo: WebpToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "WebP 이미지를 인쇄용 PDF 문서로 완벽하게 변환",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "여러 장의 WebP 사진이나 스캔 문서를 하나의 정돈된 PDF 파일로 합쳐주는 도구입니다. 용지 사양과 방향, 여백을 자유롭게 조절하세요."
  },
  {
    "type": "title",
