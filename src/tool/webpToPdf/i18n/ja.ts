...
const title = "WebP PDF 変換ツール";
const description = "ブラウザ上でWebP画像を整列されたPDFに変換。ファイルをアップロードすることなく、用紙サイズや向き、余白を設定できます。";

const ui: ImageToPdfUI = {
  formatLabel: 'WebP',
  dropTitle: "WebP画像からPDFを作成",
  dropText: "ここにWebPファイルをドロップ。選択した順番がそのままページ順になります。",
  selectFiles: "WebPファイルを選択",
  ...
  invalidFile: "このツールはWebPおよびJPEGファイルのみに対応しています。",
...
const faq: WebpToPdfLocaleContent['faq'] = [
  {
    "question": "複数のWebP画像を1つのPDFにまとめられますか？",
    "answer": "はい。必要なだけのWebPファイルを選択し、ページ順を整えて1つのPDFファイルとして出力できます。"
  },
  {
...
const howTo: WebpToPdfLocaleContent['howTo'] = [
  {
    "name": "WebP画像を選択",
    "text": "WebPファイルをドラッグ＆ドロップするか、デバイスから選択します。"
  },
  {
    "name": "ページと用紙の設定",
...
const seo: WebpToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "WebP画像を印刷に適した高品質なPDFへ変換",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "複数枚のWebP画像やスキャンデータを、1つのきれいなPDFファイルにまとめるツールです。ページ順の変更や用紙サイズ・余白の指定も簡単に行えます。"
  },
  {
    "type": "title",
