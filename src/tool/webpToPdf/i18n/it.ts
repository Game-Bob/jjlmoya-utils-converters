...
const slug = 'convertitore-da-webp-a-pdf';
const title = "Convertitore da WebP a PDF";
const description = "Converti immagini WebP in un PDF ordinato nel tuo browser. Scegli formato carta, orientamento e margini senza caricare file.";

const ui: ImageToPdfUI = {
  formatLabel: 'WebP',
  dropTitle: "Crea un PDF dalle tue immagini WebP",
  dropText: "Trascina qui i file WebP. L ordine scelto sarà l ordine delle pagine.",
  selectFiles: "Seleziona file WebP",
  ...
  invalidFile: "Questo strumento accetta solo file WebP e JPEG.",
...
const faq: WebpToPdfLocaleContent['faq'] = [
  {
    "question": "Posso unire più immagini WebP in un unico PDF?",
    "answer": "Sì. Seleziona i file WebP desiderati, ordina le pagine ed esporta un unico documento PDF."
  },
  {
...
const howTo: WebpToPdfLocaleContent['howTo'] = [
  {
    "name": "Seleziona le immagini WebP",
    "text": "Trascina i file WebP o sceglili dal tuo dispositivo."
  },
  {
...
const seo: WebpToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "Trasforma le tue immagini WebP in un PDF pronto per la stampa",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "Questo convertitore da WebP a PDF ti permette di unire scansioni e foto in un unico documento organizzato. Personalizza l ordine delle pagine e la disposizione del foglio."
  },
  {
    "type": "title",
