...
const title = "WebP 转 PDF 转换器 Tool";
const description = "在浏览器中将 WebP 图片转换为排版整齐的 PDF。无需上传文件，轻松选择纸张大小、方向及页边距。";

const ui: ImageToPdfUI = {
  formatLabel: 'WebP',
  dropTitle: "根据 WebP 图片生成 PDF",
  dropText: "拖放 WebP 文件至此处。您排列的顺序将直接作为 PDF 的页面顺序。",
  selectFiles: "选择 WebP 文件",
  ...
  building: "正在生成 PDF",
  pdfReady: "您的 PDF 已就绪",
  invalidFile: "本工具仅支持 WebP 和 JPEG 格式文件。",
...
const faq: WebpToPdfLocaleContent['faq'] = [
  {
    "question": "可以将多张 WebP 图片合并为一个 PDF 吗？",
    "answer": "可以。只需选择需要的 WebP 文件，调整好页面先后顺序，即可导出一份完整的 PDF 文档。"
  },
  {
...
const seo: WebpToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "将 WebP 图片快速合并为便于打印的 PDF 文档",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "这款 WebP 转 PDF 转换器能够帮您把多张照片或扫描件整合成一个结构清晰的 PDF 文件。支持自由调整排序与页面规格。"
  },
  {
    "type": "title",
    "text": "制作精美 PDF 的小技巧",
