...
const slug = 'convertitore-da-png-a-pdf';
const title = "Convertitore da PNG a PDF";
const description = "Converti immagini PNG in un PDF ordinato nel tuo browser. Scegli formato carta, orientamento e margini senza caricare file.";

const ui: ImageToPdfUI = {
  formatLabel: 'PNG',
  dropTitle: "Crea un PDF dalle tue immagini PNG",
  dropText: "Trascina qui i file PNG. L ordine scelto sarà l ordine delle pagine.",
  selectFiles: "Seleziona file PNG",
  ...
  invalidFile: "Questo strumento accetta solo file PNG e JPEG.",
...
const faq: PngToPdfLocaleContent['faq'] = [
  {
    "question": "Posso unire più immagini PNG in un unico PDF?",
    "answer": "Sì. Seleziona i file PNG desiderati, ordina le pagine ed esporta un unico documento PDF."
  },
  {
...
const howTo: PngToPdfLocaleContent['howTo'] = [
  {
    "name": "Seleziona le immagini PNG",
    "text": "Trascina i file PNG o sceglili dal tuo dispositivo."
  },
  {
...
const seo: PngToPdfLocaleContent['seo'] = [
  {
    "type": "title",
    "text": "Trasforma le tue immagini PNG in un PDF pronto per la stampa",
    "level": 2
  },
  {
    "type": "paragraph",
    "html": "Questo convertitore da PNG a PDF ti permette di unire scansioni e foto in un unico documento organizzato. Personalizza l ordine delle pagine e la disposizione del foglio."
  },
  {
    "type": "title",
